...
# $Header: /var/cvsroot/gentoo-x86/games-strategy/glest/glest-3.0.0.ebuild,v 1.2 2007/11/21 04:19:03 dirtyepic Exp $
...
SRC_URI="mirror://sourceforge/${PN}/${PN}-source-${PV}.tar.gz
	mirror://sourceforge/${PN}/${PN}_data_3.1.0.zip
...
src_install() {
	...
	use linguas_hu && dolang magyar_${L_PV}.lng
