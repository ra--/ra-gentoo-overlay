...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/paludis/paludis-0.34.4.ebuild,v 1.1 2009/02/11 17:01:49 cla Exp $
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "${FILESDIR}"/paludis-remove-excessive-stderr-usage.diff || die
}
