...
SRC_URI="${SRC_URI} mirror://zxy/portage-utils-hook-stuff-1.tar.bz2 mirror://paludis-extras/portage-utils-hook-stuff-1.tar.bz2"
...
src_unpack() {
	...
	unpack portage-utils-hook-stuff-1.tar.bz2 
	rm q-reinitialize.bash
}
...
src_install() {
	...
	dohook ${WORKDIR}/q-reinitialize.hook sync_all_post
